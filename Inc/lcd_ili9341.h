...
#define ILI9341_PIXEL						76800 // 16 bit
...
*/
extern void LCD_ILI9341_Init(SPI_HandleTypeDef *lcd_spi);
...
* 	- uint16_t y: Y position for pixel
* 	- uint16_t color: color of pixel
*		- uint8_t* image: pointer to image buffer
*/
extern void LCD_ILI9341_DrawPixel_ImageBuffer(uint16_t x, uint16_t y, uint16_t color, uint8_t* image);
...
*		- uint8_t* image: pointer to image buffer
*/
extern void LCD_ILI9341_Putc_ImageBuffer(uint16_t x, uint16_t y, char c, LCD_FontDef_t *font, uint16_t foreground, uint8_t* image);
...
*		- uint8_t* image: pointer to image buffer
*/
extern void LCD_ILI9341_Puts_ImageBuffer(uint16_t x, uint16_t y, char *str, LCD_FontDef_t *font, uint16_t foreground, uint8_t* image);
...
*		- uint8_t* image: pointer to image buffer
*/
extern void LCD_ILI9341_DrawLine_ImageBuffer(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint8_t* image);
...
*		- uint8_t* image: pointer to image buffer
*/
extern void LCD_ILI9341_DrawRectangle_ImageBuffer(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint8_t* image);
...
*		- uint8_t* image: pointer to image buffer
*/
extern void LCD_ILI9341_DrawFilledRectangle_ImageBuffer(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint8_t* image);
