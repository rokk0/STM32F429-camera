...
void LCD_ILI9341_SendImageFrame(uint8_t* data) {
	ILI9341_WRX_SET;
	ILI9341_CS_RESET;
	LCD_SPI_Send(data, ILI9341_SPI_IMAGE_BLOCK);
	LCD_SPI_Send(data+ILI9341_SPI_IMAGE_BLOCK, ILI9341_SPI_IMAGE_BLOCK);
	LCD_SPI_Send(data+ILI9341_SPI_IMAGE_BLOCK*2, ILI9341_SPI_IMAGE_BLOCK);
	ILI9341_CS_SET;
}
...
void LCD_ILI9341_DisplayImage(uint16_t image[ILI9341_PIXEL]) {
	...
	LCD_ILI9341_SendImageFrame((uint8_t*)image);
}
...
void LCD_ILI9341_DrawPixel_ImageBuffer(uint16_t x, uint16_t y, uint16_t color, uint8_t* image) {
	*(image + ILI9341_HEIGHT*y*2 + x*2) = color >> 8;
	*(image + ILI9341_HEIGHT*y*2 + x*2+1) = color & 0xFF;
}

void LCD_ILI9341_Putc_ImageBuffer(uint16_t x, uint16_t y, char c, LCD_FontDef_t *font, uint16_t foreground, uint8_t* image) {
	uint32_t i, b, j;
	/* Set coordinates */
	ILI9341_x = x;
	ILI9341_y = y;
...
void LCD_ILI9341_Puts_ImageBuffer(uint16_t x, uint16_t y, char *str, LCD_FontDef_t *font, uint16_t foreground, uint8_t* image) {
	uint16_t startX = x;
...
void LCD_ILI9341_DrawLine_ImageBuffer(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint8_t* image) {
	int16_t dx, dy, sx, sy, err, e2; 
...
void LCD_ILI9341_DrawRectangle_ImageBuffer(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint8_t* image) {
...
void LCD_ILI9341_DrawFilledRectangle_ImageBuffer(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint8_t* image) {
	for (; x0 < x1; x0++) {
